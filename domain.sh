#!/bin/bash
######################################################################
# TuxLitePlus virtualhost script                                     #
# Easily add/remove domains or subdomains                            #
# Configures logrotate and php7.2-FPM                         #
# Enables/disables public viewing and phpMyAdmin          #
######################################################################
...
# Variables for phpMyAdmin functions
# The path to find for phpMyAdmin symbolic links
...
function initialize_variables {
    ...
    DOMAIN_SSL_PATH="/etc/nginx/ssl/$DOMAIN"
...
<p>View MySQL/PHP Info <a href="http://$DOMAIN/phpinfo.php">Open</a></p>
</body>
</html>
EOF
...
function remove_domain {
    ...
    echo -e "* Removing pool.d file: \033[1m/etc/php/7.2/fpm/pool.d/$DOMAIN_OWNER.conf\033[0m"
    sleep 1
    rm -rf /etc/php/7.2/fpm/pool.d/$DOMAIN_OWNER.conf
